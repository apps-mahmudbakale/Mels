...
class NigeriaLocationSeeder extends Seeder
{
    public function run(): void
    {
        $nigeriaStates = [
            ...
            'Adamawa' => [
                'Demsa', 'Fufure', 'Ganye', 'Gayuk', 'Girei', 'Gombi', 'Guyuk', 'Hong', 'Jada', 'Lamurde',
            ...
            'Osun' => [
                'Atakumosa East', 'Atakumosa West', 'Aiyedaade', 'Aiyedire', 'Boluwaduro', 'Boripe', 'Ede North',
        ...
        foreach ($nigeriaStates as $state => $lgas) {
